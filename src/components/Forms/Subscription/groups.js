export const getGroupOptions = () => {
  return [
    ...
    },
    {
      ...
      specialty: ['Liderança'],
      description:
        'Será um grupo dedicado à diretoria e aos coordenadores para desenvolverem conhecimentos de liderança e gestão de equipes.',
      weekDay: 'Sexta-feira',
      startsAt: '18:00:00',
      endsAt: '19:00:00',
      lang: 'Português',
    ...
    },
    {
      ...
      description:
        'Grupo de estudos com enfoque em um melhor aproveitamento do curso por meio de técnicas de estudo e organização do tempo. O conhecimento médico deve ser abordado em encontros eventuais para discussão de casos clínicos.',
    ...
    },
    {
      ...
      description:
        'Grupo focado nas peculiaridades do USMLE e outras oportunidades de residência e trabalho no exterior. ',
      weekDay: 'Sexta-feira',
      startsAt: '16:00:00',
      endsAt: '17:00:00',
      lang: 'Inglês',
    ...
    },
    {
      ...
      description:
        'Nosso objetivo é proporcionar aos integrantes do grupo uma imersão nas chamadas soft skills. O nome pode confundir um pouco, mas na prática é bem simples! Elas são nada menos do que habilidades comportamentais, a exemplo da comunicação eficaz, da atitutude empática, da liderança da gestão de tempo e da capacidade de resolver problemas.',
      weekDay: 'Terça-feira',
      startsAt: '11:00:00',
      endsAt: '12:00:00',
      lang: 'Português',
    ...
    },
    {
      ...
      description:
        'Um grupo para apresentar técnicas de estudo voltado para nossa realidade, aumentando a eficiência do estudante de medicina. Também serão discutidos e desenvolvidos habilidades de raciocínio por meio de casos clínicos.',
      weekDay: 'Quinta-feira',
      startsAt: '18:00:00',
      endsAt: '19:30:00',
      lang: 'Português',
    ...
    },
    {
      ...
      description:
        'Grupo focado em discussão de casos clínicos para aprimorar o raciocínio clínico durante a formação acadêmica.  ',
    ...
    },
    {
      ...
      description:
        'O Mint é um espaço para discutir aplicações de programação e ciência de dados na saúde, voltado para o público com conhecimento prévio ou interesse de aprender mais sobre a área. Teremos instrução de estudantes com experiência nas áreas, mas o autodidatismo é essencial.',
      weekDay: 'Quarta-feira',
      startsAt: '18:00:00',
      endsAt: '19:00:00',
      lang: 'Português',
    ...
    },
    {
      ...
      description:
        'Nosso grupo irá abordar técnicas de estudo, gestão de tempo, planejamento de carreira, técnicas de apresentação, soft skills e muitos outros assuntos importantíssimos para sua vida profissional! ',
      weekDay: 'Quarta-feira',
      startsAt: '19:00:00',
      endsAt: '20:30:00',
      lang: 'Português',
    ...
    },
    {
      ...
      specialty: ['Resolução de casos clínicos', 'Técnicas de estudo', 'Gerenciamento de tempo'],
      description:
        'Grupo destinado à masterização do aprendizado e da alta performance pessoal e profissional, com desenvolvimento ativo de técnicas de estudo, raciocínio clínico e gestão de tempo.',
      weekDay: 'Sexta-feira',
      startsAt: '18:00:00',
      endsAt: '19:00:00',
      lang: 'Português',
    ...
    },
    {
      ...
      description:
        'Nosso grupo tem como foco principal  discussão de casos clínicos, as técnicas de estudo e também, as didáticas de apresentação. Além disso, como proposição do Gedaam, as demais necessidade e demandas dos componentes, associadas aos pilares do grupo. Por último, e não menos importante o raciocínio clínico médico.',
      weekDay: 'Quinta-feira',
      startsAt: '19:00:00',
      endsAt: '20:30:00',
      lang: 'Português',
    ...
    },
    {
      ...
      description:
        'Abordará os principais pilares do GEDAAM, tais quais técnicas de estudo, técnicas de apresentação e resolução de casos clínicos.',
      weekDay: 'Quinta-feira',
      startsAt: '19:00:00',
      endsAt: '20:30:00',
      lang: 'Português',
